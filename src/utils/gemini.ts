...
จงวิเคราะห์ความต้องการเชิงภาพ บรรยากาศ (Mood & Tone) และแปลงเป็นคีย์เวิร์ดลักษณะทางกายภาพ/ประเภทสถานที่จริงที่มีในฐานข้อมูล ททท. 
(เช่น หากบรีฟว่า "บรรยากาศโรแมนติก" -> แปลงเป็น จุดชมวิว, พระอาทิตย์ตก, ริมทะเล, ชายหาด, ทิวทัศน์, ดอย
หากบรีฟว่า "ลึกลับ ยุคโบราณ" -> วัดร้าง, โบราณสถาน, ถ้ำ, ป่าดงดิบ
หากบรีฟว่า "สดชื่น ผ่อนคลาย" -> น้ำตก, ลำธาร, อ่างเก็บน้ำ, สวนดอกไม้)

ตอบกลับเป็น JSON ในรูปแบบนี้เท่านั้น:
{
  "expandedKeywords": ["คีย์เวิร์ดลักษณะสถานที่หรือภูมิทัศน์จริงในไทย 4-7 คำ ที่มีความหมายเชื่อมโยงกับบรีฟ"],
