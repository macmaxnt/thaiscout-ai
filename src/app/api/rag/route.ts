    ...
    if (question && question.trim().length > 0) {
      ...
      if (geminiAnswer) {
        ...
        answer = `【ขั้นตอนการขออนุญาตถ่ายทำที่ ${name_th}】\n` +
          ...
          `• ข้อควรระวัง (Safe Refusal): ในฐานข้อมูล ททท. ไม่มีระบุอัตราค่าใช้จ่ายสุทธิของการถ่ายทำโฆษณา/ภาพยนตร์ เพื่อป้องกันความคลาดเคลื่อน กรุณาโทรติดต่อสอบถามโดยตรงที่: ${tel || "สำนักงาน ททท. จังหวัด"}\n` +
    ...
    const dossier = {
      cinematicAnalysis: {
        ...
        soundEnvironment: name_th.includes("น้ำตก") || name_th.includes("ลำธาร")
          ? "มีเสียงสายน้ำตกและเสียงลมธรรมชาติคงที่ จำเป็นต้องใช้ไมค์ Boom แบบ Directional สูง หรือวางแผนอัดเสียง Dialogue ในห้องพากย์ (ADR)"
