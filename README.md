...
| ข้อจำกัด | รายละเอียด |
|---------|-----------|
| **ประเภทสถานที่จำกัด** | ฐานข้อมูล TAT มีเฉพาะสถานที่ท่องเที่ยว วัด และธรรมชาติ (~45%) ไม่มีคาเฟ่ ร้านอาหาร หรือโรงแรม |
| **ข้อมูลไม่ Real-time** | ข้อมูลเป็น Snapshot จาก TAT ณ เวลาหนึ่ง อาจไม่ตรงกับสภาพจริงปัจจุบัน (เช่น สถานที่ปิดปรับปรุง) |
| **ขาดข้อมูลเชิงลึก** | บางสถานที่ไม่มีเบอร์ติดต่อ (10.6%) หรือข้อมูลค่าเข้าชม ทำให้ AI ต้องแนะนำให้ติดต่อเองแทน |

### 🤖 AI Engine
| ข้อจำกัด | รายละเอียด |
|---------|-----------|
| **Context Window** | ส่งข้อมูลสถานที่ให้ Gemini ได้สูงสุด ~1,000 รายการต่อ request เพื่อป้องกัน token overflow จากทั้งหมด 8,628 แห่ง |
| **Match Score ไม่ใช่ Ground Truth** | คะแนน % เป็นการประเมินของ AI ไม่ใช่ค่าวัดจากข้อมูลจริง อาจเปลี่ยนได้แต่ละครั้งที่ถาม |
| **Rate Limit** | Gemini API มี quota จำกัด หากมีผู้ใช้พร้อมกันมากอาจช้าหรือ error |
| **ภาษา** | ออกแบบมาสำหรับภาษาไทยเป็นหลัก การใช้บรีฟภาษาอังกฤษอาจได้ผลลัพธ์ที่แม่นยำน้อยกว่า |

### 🗺️ แผนที่ & เส้นทาง
| ข้อจำกัด | รายละเอียด |
|---------|-----------|
| **ระยะทางเป็น Straight Line** | คำนวณระยะทางแบบ Haversine (เส้นตรง) ไม่ใช่ระยะทางถนนจริง อาจต่างจากความเป็นจริง |
| **ไม่มี Traffic Data** | ไม่รู้สภาพจราจรหรือเวลาเดินทางจริง ต้องเปิด Google Maps เพื่อดู Navigation จริง |

### 👤 ผู้ใช้งาน
| ข้อจำกัด | รายละเอียด |
|---------|-----------|
| **ไม่มีระบบ Login** | Collection/Recce Board บันทึกใน `localStorage` ของเบราว์เซอร์ ถ้าเปลี่ยนอุปกรณ์หรือล้าง cache จะหายทั้งหมด |
| **ไม่ Sync ข้ามอุปกรณ์** | ไม่สามารถแชร์คลังสถานที่ระหว่างสมาชิกทีมได้โดยตรง |

### 🖼️ รูปภาพ
| ข้อจำกัด | รายละเอียด |
|---------|-----------|
| **Google Places Photos** | บางสถานที่ที่ไม่ค่อยมีชื่อเสียงอาจไม่มีรูปภาพใน Google Places ระบบจะแสดง placeholder แทน |
